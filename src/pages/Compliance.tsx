      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="space-y-8">
          <Card className="border border-border shadow-lg bg-card/50 backdrop-blur">
            ...
            <CardContent>
              <div className="h-48 overflow-y-auto p-4 bg-card border border-border rounded-xl">
                {cloudflareText ? (
                      ...
                      <CardContent className="p-6">
                        <div className="prose prose-invert max-w-none">
                          <div className="markdown-content">
                            <pre className="whitespace-pre-line text-foreground">{complianceResponse}</pre>
                          </div>
                        </div>
                      </CardContent>
                    </Card>
